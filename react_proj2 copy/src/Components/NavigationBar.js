      ...
      <div className="container">
        <div className="dropdown" onClick={toggleDropdown}>
          <button className="dropbtn">
            <FaUser className="profile-icon" /> {/* User icon from Font Awesome */}
          </button>
          {/* Dropdown content */}
          {dropdownVisible && (
            <div className="dropdown-content">
              ...
              <button className="dropdown-button logout-button" onClick={() => window.location.href = '/donate'}>Log out</button>
