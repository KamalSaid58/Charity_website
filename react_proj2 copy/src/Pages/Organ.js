...
import SampleImage from './Organ.jpeg';
import SampleImage1 from './Organ2.png';
import SampleImage2 from './Organ3.jpg';
      ...
      <div className={styles.section}>
        ...
        <ul>
          {donationHistory.map(donation => (
            <li key={donation.id}>
              <span>Quantity Donated: {donation.amount}</span>
