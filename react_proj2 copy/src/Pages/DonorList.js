...
const DonorList = () => {
  ...
  const originalDataSource = [
    ...
    },
    {
      ...
      {
        key: '3',
        DonorName:'Said Faramawy',
        DonorGender:'Male',
        DonorEmail:'@said.faramawy',
        DonorNumber:'010282880077', 
        DonorAddress: 'Monofia,Ewesna',
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'DonorName',
      key: 'DonorName',
      ...getColumnSearchProps('DonorName'),
    },
    
    {
      ...
      key: 'DonorAddress',
      ...getColumnSearchProps('DonorAddress'),
    },
