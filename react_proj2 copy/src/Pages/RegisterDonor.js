    ...
    <div className="container p-3 my-1">
      <div className="row">
        <div className="col-4 col-md-6">
          ...
          <div className="mb-3">
            <input type="text" className="form-control form-control-sm" id="Address" placeholder="Address" />
          </div>
          <div className="mb-3">
          ...
          <Form.Item >
          <Select defaultValue="Donor type" className="defaultValue" onChange={handleTypeChange}
            >
              <Select.Option value="Regular donor">Regular donor</Select.Option>
              <Select.Option value="Doctor">Doctor</Select.Option>
              <Select.Option value="Teacher">Teacher</Select.Option>
            </Select>
          </Form.Item>
            
        {showUploadButton && ( <div className="mb-3">
