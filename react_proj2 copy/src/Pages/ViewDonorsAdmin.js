...
const DonorList = () => {
  ...
  const handleDownload = async () => {
    ...
    selectedRecords.forEach((record) => {
      ...
      y -= 20;
      page.drawText(`Profession: ${record.DonorProfession}`, {
        x: 50,
        y,
        size: 12,
        color: rgb(0, 0, 0),
  ...
  const columns = [
    ...
    {
      title: "Profession",
      dataIndex: "DonorProfession",
      key: "DonorProfession",
      ...getColumnSearchProps("DonorProfession", "Profession"),
    },
