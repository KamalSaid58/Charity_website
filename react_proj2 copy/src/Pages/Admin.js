    ...
    <div style={{ height: '100vh' }}>
      <Layout style={{ height: '100%' }}>
        ...
        >
          ...
          >
            <Menu.Item key="1"  onClick={() => handleButtonClick('DonorList')} icon={<UserOutlined  />} >
            Donor Lists {/* Changed the icon here */}
            </Menu.Item>
           <Menu.Item key="2"  onClick={() => handleButtonClick('OrganList')} icon={<ShoppingCartOutlined />} >
            OrganList {/* Changed the icon here */}
            </Menu.Item>
